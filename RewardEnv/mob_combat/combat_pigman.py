...
from mineclip.dense_reward import MobCombatDenseRewardWrapper


class CombatPigmanDenseRewardEnv(MobCombatDenseRewardWrapper):
    def __init__(
        self,
